...
![Post it nightmare](/slides/init-software-craftsmanship/img/postItNightmare.jpg) <!-- .element style="width: 80%;" -->
...
![Crazy Coder](/slides/init-software-craftsmanship/img/Fotolia_56962791_M.jpg) <!-- .element style="width: 80%;" -->
...
<!-- .slide: data-background-color="black" data-background-size="contain" data-background-repeat="no-repeat" -->
![agileManifesto](/slides/init-software-craftsmanship/img/craftsmanship/craftsmanshipmanifesto.png) <!-- .element style="border: 0; background: None; box-shadow: None;width: 70%;" -->
...
1. Une voiture qui roule aujourd'hui n'est pas suffisant, il faut qu'elle roule demain. Sa longé vité  passe par la qualité  de fabrication.
...
![agileManifesto](/slides/init-software-craftsmanship/img/xp_practices.jpg) <!-- .element style="border: 0; background: None; box-shadow: None;width: 80%;" -->
